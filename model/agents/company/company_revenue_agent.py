...
class CompanyRevenueAgent(AbstractAgent):
    ...
    def make_runnable(self, **kwargs) -> Runnable:
        ...
        tools = [
            ...
            Tool(
                name="ConvertToEuro",
                description="Dato un JSON, converte un importo con valuta (ad esempio '1000000 USD') in euro.",
        ...
        starting_prompt = PromptTemplate.from_template("Restituisci SOLO il fatturato dell'azienda {company_name} in euro. Usa la query: How much is the most recent global turnover of the company {company_name}?")
